...
const Home:React.FC = () => (
    <div className="relative w-screen h-screen mt-[90px]">
        ...
        <div className="w-full h-full flex justify-between items-center -mt-[90px] px-32">
            <div>
                <div>
                    <h3 className="text-6xl font-bold text-[#F4F4F4]">Unleash the power of</h3>
                    <h3 className="text-6xl font-bold text-[#F4F4F4]">fire in your</h3>
                    <h3 className="text-6xl font-bold text-[#F4F4F4]">investments</h3>
                </div>
